...
export default function SearchScreen() {
  ...
  return (
    <View className="flex-1 bg-bg">
      ...
      {/* Portion Modal */}
      <Modal visible={!!selected} animationType="none" transparent statusBarTranslucent>
      ...
      <Modal visible={addFoodVisible} animationType="none" transparent statusBarTranslucent>
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
          <View style={{ flex: 1 }}>
            <TouchableWithoutFeedback onPress={() => setAddFoodVisible(false)}>
              <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.3)' }} />
            </TouchableWithoutFeedback>
